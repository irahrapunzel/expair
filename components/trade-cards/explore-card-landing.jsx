...
export default function ExploreCardLanding({
    ...
    return (
        <div
        className="w-full md:w-[455px] rounded-[20px] border-[3px] border-[#284CCC]/80 p-4 md:p-[25px] gap-3 md:gap-[15px] flex flex-col relative transition-all duration-300 hover:scale-[1.01]"
        style={{
            background:
        ...
        <div className="flex justify-between items-start w-full">
            ...
            <div className="flex flex-col gap-[5px]">
                ...
                <div className="flex gap-[15px] items-center text-xs md:text-sm text-white/90">
                {/* Rating */}
        ...
        <div className="flex justify-between items-start gap-4 flex-wrap">
            ...
            <span className="text-xs md:text-sm text-white/80 font-medium">Needs</span>
            <div
                className="inline-block px-[15px] py-[7px] rounded-[15px] border-[2px] border-[#5A5AFF] bg-[#5A5AFF33] text-xs md:text-sm text-white/90 max-w-[140px] md:max-w-[180px] overflow-hidden text-ellipsis whitespace-nowrap"
                title={need}
            >
                {need}
            </div>
            ...
            <span className="text-xs md:text-sm text-white/80 font-medium">Can offer</span>
            <div
                className="inline-block px-[15px] py-[7px] rounded-[15px] border-[2px] border-[#906EFF] bg-[#906EFF33] text-xs md:text-sm text-white/90 max-w-[140px] md:max-w-[180px] overflow-hidden text-ellipsis whitespace-nowrap text-right"
                title={offer}
            >
                {offer}
            </div>
        ...
        <div className="mt-[0px] flex justify-end">
            <span className="text-xs md:text-sm text-white/50">{formattedDeadline}</span>
        </div>
        </div>
    );
}