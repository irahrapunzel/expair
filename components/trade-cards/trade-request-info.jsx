  ...
  return (
    <div className="px-8 py-6 bg-[#0A0519] rounded-[20px] mb-[15px]">
      <div className="flex flex-wrap items-start gap-8">
        {/* You're requesting */}
        <div className="flex flex-col gap-2 flex-1 min-w-[100%] items-start">
        ...
        <div className="flex flex-col gap-2 flex-1 min-w-[100%] items-end">
          <span className="text-[18px] text-white/80 font-medium text-right whitespace-nowrap">
            In exchange, you'll provide
          </span>
          <div
