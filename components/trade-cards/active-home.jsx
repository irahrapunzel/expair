...
export default function ActiveTradeHome({ 
  ...
  return (
    <div
      className="flex flex-col justify-between w-[455px] rounded-[20px] border-[3px] border-[#284CCC]/80 p-[25px] gap-[20px] relative cursor-pointer hover:scale-[1.02] transition-transform duration-300"
      style={{
