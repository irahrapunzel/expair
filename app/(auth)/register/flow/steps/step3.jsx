...
export default function Step3({ step3Data, onDataSubmit, onNext, onPrev }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-[20px] sm:bottom-[60px] right-4 sm:right-[40px] max-w-[280px] sm:max-w-[422px] text-[10px] sm:text-[13px] text-white/40 text-right z-50 pointer-events-none sm:pointer-events-auto">
